  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Total Events */}
        <div className="bg-yellow-50 rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-transform transform hover:-translate-y-2 border border-yellow-300">
        ...
        {/* Inquiries */}
        <div className="bg-blue-50 rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-transform transform hover:-translate-y-2 border border-blue-300">
        ...
        {/* Revenue */}
        <div className="bg-green-50 rounded-3xl p-6 min-h-[150px] w-80 shadow-lg hover:shadow-2xl transition-transform transform hover:-translate-y-2 border border-green-300">
