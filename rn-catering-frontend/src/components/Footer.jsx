    ...
    <footer className="bg-black text-white px-5 py-10">
      <div className="max-w-[1300px] mx-auto flex flex-wrap justify-between gap-8">
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={category}>
                <a href="#" className="hover:text-purple-500 transition">{category}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <ul className="space-y-2">
            <li><Link className="hover:text-purple-500 transition" to="/">Home</Link></li>
            <li><Link className="hover:text-purple-500 transition" to="/about">About Us</Link></li>
            <li><Link className="hover:text-purple-500 transition" to="/services">Our Services</Link></li>
            <li><Link className="hover:text-purple-500 transition" to="/privacyTos">Terms of Service</Link></li>
            <li><Link className="hover:text-purple-500 transition" to="/privacyTos">Privacy</Link></li>
            <li><Link className="hover:text-purple-500 transition" to="/contact">Contact Us</Link></li>
          </ul>
        </div>
        ...
        <div className="flex-1 min-w-[200px]">
          ...
          <ul className="space-y-2">
            <li><a href="mailto:info@rncatering.com" className="hover:text-purple-500 transition">info@rncatering.com</a></li>
            <li><a href="tel:+918799013176" className="hover:text-purple-500 transition">+91 12345 67890</a></li>
          </ul>
        </div>
      </div>
