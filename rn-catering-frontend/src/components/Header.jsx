    ...
    <>
      ...
      {showMobileNav && (
        <div className="flex flex-col md:hidden w-full bg-white text-gray-800 shadow-md px-4">
          <Link to="/" className="py-2 hover:bg-purple-700 hover:text-white">Home</Link>
          <Link to="/about" className="py-2 hover:bg-purple-700 hover:text-white">About</Link>
          <Link to="/services" className="py-2 hover:bg-purple-700 hover:text-white">Our Services</Link>
          <Link to="/venues" className="py-2 hover:bg-purple-700 hover:text-white">Venues</Link>
          <Link to="/contact" className="py-2 hover:bg-purple-700 hover:text-white">Contact</Link>
          {!user ? (
            <button onClick={toggleDropdown} className="text-left py-2 hover:bg-purple-700 hover:text-white">Sign In</button>
          ) : (
            <>
              <Link to="/profile" className="py-2 hover:bg-purple-700 hover:text-white">Profile</Link>
            ...
            <div className="relative z-10">
              {authForm === "signin" && (
                <>
                  ...
                  >
                    <label>Email</label>
                    <input type="text" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter email" required className="px-3 py-2 border border-gray-300 rounded-full" />
                    <label>Password</label>
                    <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" required className="px-3 py-2 border border-gray-300 rounded-full" />
