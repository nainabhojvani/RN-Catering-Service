...
export default function SignInForm({ setAuthForm, setShowDropdown, setCenteredMsg, login }) {
    ...
    return (
        <>
            <h3 className="text-lg font-bold text-center mb-4 text-[#19522f]">Sign In</h3>
