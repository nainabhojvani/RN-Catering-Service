...
const events = [
  {
    ...
    defaultImg: e1,
    hoverImg: e1h,
    desc: "Crafting unforgettable wedding menus that blend elegance and flavor to suit every tradition and taste.",
  },
  {
...
export default function ServicesCard() {
  ...
  return (
    <div className="px-6 md:px-16 py-10 bg-gray-100">
      <h2 className="text-center text-4xl font-bold mb-10 font-['Dancing_Script',cursive] text-purple-800">
        Feast-Worthy Moments, Crafted With Care
      </h2>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-purple-700 text-white rounded-2xl p-6 shadow-2xl flex flex-col justify-between transition-transform duration-700 ease-in-out backface-hidden transform rotate-y-180">
                <p className="text-2xl leading-relaxed text-white font-large text-center px-2 mt-6 font-['Dancing_Script',handwriting]">
                  {event.desc}
                </p>
                <button className="bg-white text-purple-800 px-5 py-2 rounded-full font-semibold text-sm  transition">
                  Choose Menu
                </button>
              </div>
            </div>
