...
function AboutHero() {
  return (
    <div className="relative w-full">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center text-2xl md:text-4xl font-['Dancing_Script',cursive]">
...
function Founders() {
  ...
  return (
    <>
      <h2 className="text-3xl md:text-4xl px-6 font-['Dancing_Script',cursive] mb-4">Meet the Founders</h2>
      {people.map((person, idx) => (
        ...
        >
          ...
          <div className="max-w-2xl">
            <h2 className="text-2xl mb-3 font-['Dancing_Script',cursive]">{person.name}</h2>
