    ...
    <>
      ...
      {showMobileNav && (
        <div className="flex flex-col md:hidden w-full bg-white text-gray-800 shadow-md px-4">
          ...
          <button
            onClick={toggleDropdown}
            className="text-left py-2 hover:bg-purple-700 hover:text-whit "
          >
            Sign In
          </button>
        </div>
      ...
      {showDropdown && (
        <div className="relative z-50">
          <div className="absolute right-10 mt-2 w-[30rem] p-6 bg-white/95 rounded-lg shadow-lg">
              ...
              {authForm === "signin" && (
                <>
                  ...
                  <form className="flex flex-col gap-3 font-semibold">
                    ...
                    <button type="submit" className="mt-3 bg-purple-700 text-white rounded-full py-2">
                      Sign In
                    </button>

                    <p className="text-center mt-2">
                      Don’t have an account?{" "}
                      <button type="button" onClick={() => toggleAuthForm("signup")} className="text-purple-700 underline">
                        Sign Up
                      </button>
                    </p>
                  </form>
              ...
              {authForm === "signup" && (
                <>
                  ...
                  <form className="flex flex-col gap-3 font-semibold">
                    ...
                    <input type="text" placeholder="Enter username" required className="px-3 py-2 border border-gray-300 rounded-full" />

                    <label>Full Name</label>
                    <input type="text" placeholder="Enter full name" required className="px-3 py-2 border border-gray-300 rounded-full" />

                    <label>City</label>
                    <input type="text" placeholder="Enter city" required className="px-3 py-2 border border-gray-300 rounded-full" />

                    <label>Email</label>
                    <input type="email" placeholder="Enter email" required className="px-3 py-2 border border-gray-300 rounded-full" />

                    <label>Phone Number</label>
                    <input type="tel" placeholder="Enter phone number" required className="px-3 py-2 border border-gray-300 rounded-full" />

                    <label>Password</label>
                    <input type="password" placeholder="Enter password" required className="px-3 py-2 border border-gray-300 rounded-full" />

                    <label>Confirm Password</label>
                    <input type="password" placeholder="Confirm password" required className="px-3 py-2 border border-gray-300 rounded-full" />
                    ...
                    <p className="text-center mt-2">
                      ...
                      <button type="button" onClick={() => toggleAuthForm("signin")} className="text-purple-700 underline">
                        Sign In
                      </button>
                    </p>
                  </form>
