      ...
      {events.map((event, index) => (
        <div key={event.title}>
          <div className="relative py-12 px-4">
            ...
            <div
              className={`relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                }`}
            >

              {/* ICON */}
              <motion.div
                className={`relative z-10 max-w-5xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                  }`}
              ...
              >
                <h2 className="relative z-10 text-4xl font-bold mb-4 items-center justify-center text-purple-400 font-['Dancing_Script',cursive]">{event.title}</h2>
                <p className="relative z-10 mb-6 text-lg leading-relaxed  items-center justify-center text-black">{event.desc}</p>
                <motion.button
                ...
                >
                  <Link
                    to="/menu"
                    className="relative z-10 mt-4 inline-block px-8 py-3 bg-gradient-to-r from-purple-700 to-pink-600 text-white text-lg font-semibold rounded-full shadow-lg hover:scale-105 transition-transform"
                  >
                    Book Now
                  </Link>
                </motion.button>
