  ...
  return (
    <div className="bg-gray-100 rounded-lg border border-gray-300 overflow-hidden">
      <button
        ...
        className="w-full text-left px-5 py-4 font-semibold relative bg-white"
      >
        {question}
      ...
      {isOpen && (
        <div className="px-5 py-3 bg-gray-200 text-sm border-t border-gray-300">
          {answer}
        </div>
      )}
    </div>
  ...
  return (
    <div>
      <div className="text-center">
        <img src={venueHeader} alt="Venue Header" className="w-full h-[400px] object-cover" />
        <h1 className="text-4xl mt-4 font-dancing">Our Venues</h1>
        <p className="text-lg mt-2">
          Discover exceptional venues where RN Catering delivers unforgettable experiences for every occasion.
        </p>
      </div>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 max-w-[1200px] mx-auto px-5">
        {venues.map((venue, i) => (
          <div
            key={i}
            className="bg-white rounded-lg shadow-md p-5 text-center overflow-hidden"
          >
            <img
              src={venue.img}
              alt={venue.title}
      ...
      <section className="py-16 max-w-[1200px] mx-auto px-5">
        <h2 className="text-3xl text-center mb-10 font-semibold">Frequently Asked Questions</h2>
      ...
      <section className="text-center max-w-[1200px] bg-purple-700 text-white py-12 rounded-xl mx-auto my-12">
        <h2 className="text-2xl font-semibold">Ready to Host Your Event?</h2>
        <p className="text-lg mt-3 mb-6">Contact RN Catering today and let's plan your perfect celebration.</p>
        <a
          href="/contact"
          className="inline-block bg-green-300 text-black font-bold py-3 px-6 rounded-lg hover:bg-green-400 transition"
        >
          Get in Touch
        </a>
      </section>
